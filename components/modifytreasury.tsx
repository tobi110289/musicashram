    ...
    <div className="flex flex-col mx-auto">
      <div className="flex mb-2">
        <input
          type="number"
          placeholder="Amount"
          className="border-darkred shadow appearance-none border rounded w-32 h-12 py-2 px-3 bg-yellow placeholder-orange text-darkred leading-tight focus:outline-none focus:shadow-outline text-2xl text-center"
          value={treasuryInput}
