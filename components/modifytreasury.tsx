    ...
    <div className="flex flex-col mx-auto">
      <div className="flex mb-2">
        <input
          type="number"
          placeholder="Amount"
          className="border-darkred shadow appearance-none border rounded w-32 h-12 py-2 px-3 text-grey-600 leading-tight focus:outline-none focus:shadow-outline text-2xl"
          value={treasuryInput}
